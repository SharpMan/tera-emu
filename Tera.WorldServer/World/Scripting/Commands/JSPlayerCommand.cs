...
{
    public class JSPlayerCommand : JSClass
    {
        public JSPlayerCommand(string Namespace, string FilePath, string Name)
        ...
        [JSFunction]
        public void addAuthorizedSubCommand(string SubcommandName)
        {
            //authorizedSubCommands.Clear();
            if (SubcommandName != null)
            {
                authorizedSubCommands.Add(SubcommandName);
            }
        }
        ...
        {
            return Program.currentTimeMillis();
        }
        ...
        public bool callAction(WorldClient Client, CommandParameters Params)
        {
            ...
            { 
                ...
                Params.ChangeParametersAfter(2);
        ...
        {
            Client.Send(new ChatGameMessage(message, "FF0000"));
        }

        [JSFunction]
        public void SendInformationMessage(WorldClient Client, String message)
        {
            Client.Send(new ChatGameMessage(message, "682B2B"));
        }
    }
}
