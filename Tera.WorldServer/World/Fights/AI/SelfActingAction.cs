...
{
    public class SelfActingAction : AIAction
    {
                    ...
                    if (Infos != null)
                    {
                        ...
                        if (Target != null && Target.States.HasState(FighterStateEnum.STATE_PORTE))
                        {
                            ...
                            foreach (var Layer in TargetCell.GetObjects<FightGroundLayer>())
                            {
                                ...
                                {
                                    LayerScore += (int)Math.Floor(AIAction.AIActions[AIActionEnum.SELF_ACTING].GetEffectScore(AI, -1, -1, EffectLayer, TargetList, false, true));
                                }
