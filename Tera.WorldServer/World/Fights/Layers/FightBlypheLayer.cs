...
{
    public class FightBlypheLayer : FightGroundLayer
    {
        ...
        public FightBlypheLayer(Fighter Caster, SpellLevel CastSpell, FightCell CastCell, int MasterSpellId, short Duration, String Zone)
            : base(FightObjectType.OBJECT_BLYPHE, Caster, CastSpell, CastCell, MasterSpellId, 0, Zone, Duration)
        {
        }
